...
| Lower | **Done** | **Namespace support** | 4 | 4 | `xmlns` and `xmlns:prefix` are parsed and exposed as normal attributes (see [test/unit-c-compliance.c](test/unit-c-compliance.c)); no separate namespace API or prefixed-name resolution. |
