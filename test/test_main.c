...
int main(void) {
	...
	const struct CMUnitTest* t13;
	size_t n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13;
	...
	get_unit_c_strtok_tests(&t13, &n13);

	size_t total = n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + n13;
	...
	memcpy(all + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12, t13, n13 * sizeof(struct CMUnitTest));
